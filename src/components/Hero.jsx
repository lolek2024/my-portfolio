...
export default function Hero() {
  return (
    <section
      className="relative bg-cover bg-center text-center text-white py-40 opacity-100"
    ...
    >
      ...
      <div>
        ...
        <a href="https://facebook.com/innocentlolek" target="_blank" rel="noopener noreferrer">
        <FontAwesomeIcon 
            icon={faFacebook} 
            className="text-4xl mx-2 hover:text-gray-400 cursor-pointer" 
        />
